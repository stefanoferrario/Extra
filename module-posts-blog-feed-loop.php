	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'post et-format-'.$post_format ); ?>>
		...
		<div class="post-content">
			...
			<?php if(get_field('field_58b95080e9b9c')){ ?>
				<div style="padding:0% 0% 0% 0%; font-size: 11px; color:<?php echo esc_attr( $module_title_color ); ?>; text-transform:uppercase; font-weight:bold; float:left;"> <p> <?php printf(get_field('field_58b95080e9b9c'))?></p></div>
				<?php } ?>
