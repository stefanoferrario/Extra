	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( 'Comunità Pastorale Madonna di Lourdes. Tutti i diritti riservati. | Contatta la %1$s') ), '<a href="mailto:redazione@cpmadonnadilourdes.it">redazione</a>'); ?></p>
